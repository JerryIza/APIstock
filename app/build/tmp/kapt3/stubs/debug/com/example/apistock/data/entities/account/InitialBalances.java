...
public final class InitialBalances {
    ...
    private final int totalCash = 0;
    
    public final double getAccountValue() {
        return 0.0;
    }
    
    public final int getAccruedInterest() {
        return 0;
    }
    ...
    public final int getBuyingPower() {
        return 0;
    }
    
    public final int getCashAvailableForTrading() {
        return 0;
    }
    ...
    public final int getDayTradingBuyingPowerCall() {
        return 0;
    }
    
    public final int getDayTradingEquityCall() {
        return 0;
    }
    ...
    public final int getLongMarginValue() {
        return 0;
    }
    ...
    public final int getLongStockValue() {
        return 0;
    }
    ...
    public final int getMarginBalance() {
        return 0;
    }
    ...
    int accruedInterest, @com.squareup.moshi.Json(name = "availableFundsNonMarginableTrade")
    ...
    int buyingPower, @com.squareup.moshi.Json(name = "cashAvailableForTrading")
    int cashAvailableForTrading, @com.squareup.moshi.Json(name = "cashBalance")
    ...
    int dayTradingBuyingPower, @com.squareup.moshi.Json(name = "dayTradingBuyingPowerCall")
    int dayTradingBuyingPowerCall, @com.squareup.moshi.Json(name = "dayTradingEquityCall")
    int dayTradingEquityCall, @com.squareup.moshi.Json(name = "equity")
    ...
    int longMarginValue, @com.squareup.moshi.Json(name = "longOptionMarketValue")
    int longOptionMarketValue, @com.squareup.moshi.Json(name = "longStockValue")
    int longStockValue, @com.squareup.moshi.Json(name = "maintenanceCall")
    ...
    int marginBalance, @com.squareup.moshi.Json(name = "marginEquity")
    ...
    int regTCall, @com.squareup.moshi.Json(name = "shortBalance")
