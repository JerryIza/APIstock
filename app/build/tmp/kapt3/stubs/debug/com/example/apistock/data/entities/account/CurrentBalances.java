...
public final class CurrentBalances {
    ...
    private final int longMarketValue = 0;
    ...
    public final int getLongMarketValue() {
        return 0;
    }
    ...
    int accruedInterest, @com.squareup.moshi.Json(name = "availableFunds")
    ...
    int buyingPower, @com.squareup.moshi.Json(name = "buyingPowerNonMarginableTrade")
    ...
    int longMarginValue, @com.squareup.moshi.Json(name = "longMarketValue")
    int longMarketValue, @com.squareup.moshi.Json(name = "longOptionMarketValue")
    int longOptionMarketValue, @com.squareup.moshi.Json(name = "maintenanceCall")
    ...
    int marginBalance, @com.squareup.moshi.Json(name = "moneyMarketFund")
    ...
    int shortOptionMarketValue, @com.squareup.moshi.Json(name = "sma")
    double sma) {
        super();
    }
